            ...
            <button
              ...
              className={`group inline-flex shrink-0 items-center gap-1.5 rounded-lg border px-3 py-1.5 text-xs font-medium transition cursor-pointer whitespace-nowrap ${
                isActive
                  ...
                  : "border-rule bg-white text-muted hover:border-ink/40 hover:text-ink"
              }`}
            >
              <span>{cat.name}</span>
              <span
                className={`rounded-full px-1.5 py-0.5 font-mono text-xs leading-none ${
                  isActive
                    ? "bg-paper/20 text-paper"
                    : "bg-soft text-muted group-hover:text-ink"
                }`}
              >
                {cat.count}
              </span>
