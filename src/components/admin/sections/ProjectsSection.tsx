          ...
          filteredProjects.map((proj) => {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded border border-rule bg-white px-2 py-1 font-mono"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className="w-full rounded border border-rule bg-white px-2 py-1"
                />
              </div>
              <div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded border border-rule bg-white px-2 py-1 text-xs font-mono"
              />
            </div>
