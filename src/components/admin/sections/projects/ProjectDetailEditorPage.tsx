...
export function ProjectDetailEditorPage({
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* 1. Core Identity & Basic Info Card */}
      ...
      {/* 4. Categorization & Tech Stack Card */}
      <div className="rounded-xl border border-rule bg-paper p-5 shadow-xs flex flex-col gap-4">
        <div className="flex items-center gap-2 pb-2 border-b border-rule">
      ...
      {/* 6. Architectural Case Study & System Blueprint Card */}
      <div className="rounded-xl border border-rule bg-paper p-5 shadow-xs flex flex-col gap-4">
        <ProjectDetailEditor
          project={draft}
